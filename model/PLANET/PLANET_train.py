...
if __name__ == '__main__':
    ...
    valid_loader = DataLoader(valid_dataset,batch_size=1,shuffle=False,num_workers=0,drop_last=False,collate_fn=lambda x:x[0])

    test_dataset = ProLigDataset(args.test,args.batch_size,shuffle=False,decoy_flag=False)
    test_loader = DataLoader(test_dataset,batch_size=1,shuffle=False,num_workers=0,drop_last=False,collate_fn=lambda x:x[0])
